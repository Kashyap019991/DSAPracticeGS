package org.kas.demos.Prac.CoderpatQuest.DAY11_30_09; /**
 *  
 *  e.g.
...
//last char
  ...
  static int[] getLongestUniformSubstr(String str){
    ...
    return new int[]{longestStartInd,longestCount};//str.substring(longestStartInd,longestCount+longestStartInd);
  }
