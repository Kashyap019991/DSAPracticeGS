...
Also asked about approaches and time compelxity
 */
class TimeMap {
    ...
    public void set(String key, String value, int timestamp) {
        // Use computeIfAbsent to get or create a TreeMap for the key
        data.computeIfAbsent(key, k -> new TreeMap<>()).put(timestamp, value);
    }
    
    /** 
     * Returns the most recent value of key if set was previously called on it and
    ...
    public String get(String key, int timestamp) {
        ...
        // The floorEntry method efficiently finds the entry with the greatest key
        // less than or equal to the given key.
        Map.Entry<Integer, String> entry = timestamps.floorEntry(timestamp);
        
        // If no such entry exists, it means the timestamp is too early
